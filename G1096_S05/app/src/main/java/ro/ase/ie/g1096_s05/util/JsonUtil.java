package ro.ase.ie.g1096_s05.util;
...
public class JsonUtil {
    ...
    private static Movie readJsonMovie(JSONObject jsonObject) throws JSONException, ParseException {
        ...
        GenreEnum mGenre = GenreEnum.valueOf(genre);
        ...
        return new Movie(title, mRelease, duration, recommended, mGenre, mApproval, poster, rating, budget);
    }
}